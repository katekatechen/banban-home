  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full overflow-hidden rounded-t-[22px] ios-backdrop px-5 pb-[calc(20px+env(safe-area-inset-bottom))] pt-5"
      ...
      >
        {stage === "idle" && (
          <button
            onClick={onClose}
            aria-label="關閉"
            className="ios-surface ios-pressable ios-round absolute right-3.5 top-3.5 flex size-10 items-center justify-center text-gray-800"
          >
        ...
        <div className="ios-inset mt-4 flex items-center gap-3 p-3.5">
          <div
        ...
        <div className="mt-4 flex flex-col gap-3 text-[14px]">
          ...
          >
            ...
            <span className="flex items-center gap-2">
              <span className={redeemed > 0 ? "text-brand" : "text-gray-500"}>
          ...
          <div className="flex items-center justify-between border-t border-[rgba(0,0,0,0.08)] pt-3">
        ...
        <button
          ...
          disabled={stage !== "idle"}
          className="ios-accent ios-pressable mt-5 flex w-full items-center justify-center gap-2 rounded-xl py-3.5 text-[15px] font-bold text-white disabled:opacity-70"
        >
          {stage === "success" ? (
