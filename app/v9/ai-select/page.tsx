...
import { HOLDINGS, REWARD_BALANCE } from "../_lib/mock-data";
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pb-2 pt-1">
        <div className="flex items-center gap-2">
          <BackButton dark />
          <p className="text-[20px] font-bold">智能選酒</p>
        </div>
        <Link
      ...
      <div className="flex flex-col gap-4 px-4 pb-8 pt-2">
        <Link href="/v9/collection" className="block">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/v9/collection" className="text-[13px] text-sky-400">
            查看全部
          </Link>
        </div>
