...
export const SERVICE_POOL: ServiceItem[] = [
  { key: "ai-select", label: "智能選酒", emoji: "🥃", href: "/v7/ai-select", disabled: false },
  { key: "wine-select", label: "線上藏酒", emoji: "🍷", href: "/v7/wine-select", disabled: false },
  { key: "reward-marketplace", label: "回饋許願池", emoji: "🎁", href: "/v7/reward-marketplace", disabled: false },
  { key: "rate-forecast", label: "匯率預測", emoji: "💱", href: "/v7/rate-forecast", disabled: false },
