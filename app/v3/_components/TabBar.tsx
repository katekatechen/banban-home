...
const TABS = [
  { href: "/v3/banbun", label: "伴伴", icon: "/icons/tab-banbun.svg" },
  { href: "/v3/wine-select", label: "精選酒品", icon: "/icons/tab-wine-select.svg" },
  { href: "/v3/ai-select", label: "智能選品", icon: "/icons/tab-ai-select.svg" },
  { href: "/v3/experience", label: "體驗", icon: "/icons/tab-experience.svg" },
  { href: "/v3/account", label: "帳號", icon: "/icons/tab-account.svg" },
] as const;
